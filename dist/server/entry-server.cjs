...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = new Set())).add("/home/forceuser/Projects/email-sender/src/App.vue");
...
const _withId$1 = /* @__PURE__ */ vue.withScopeId("data-v-0af4e058");
const _sfc_ssrRender = /* @__PURE__ */ _withId$1((_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) => {
  _push(`<h1${serverRenderer.ssrRenderAttrs(_attrs)} data-v-0af4e058>${serverRenderer.ssrInterpolate($setup.msg)}</h1>`);
});
_sfc_main$2.ssrRender = _sfc_ssrRender;
_sfc_main$2.__scopeId = "data-v-0af4e058";
const _sfc_setup$2 = _sfc_main$2.setup;
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("/home/forceuser/Projects/email-sender/src/pages/About.vue");
...
const _withId = /* @__PURE__ */ vue.withScopeId("data-v-0575e15f");
const _sfc_main$1 = {
  expose: [],
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><h1 data-v-0575e15f>Home</h1><p data-v-0575e15f><img${serverRenderer.ssrRenderAttr("src", _imports_0)} alt="logo" data-v-0575e15f></p><button data-v-0575e15f> count is: ${serverRenderer.ssrInterpolate(vue.unref(state).count)}</button>`);
      _push(serverRenderer.ssrRenderComponent(vue.unref(Foo2), null, null, _parent));
      _push(`<p class="virtual" data-v-0575e15f> msg from virtual module: ${serverRenderer.ssrInterpolate(vue.unref(foo$1).msg)}</p>`);
      _push(serverRenderer.ssrRenderComponent(vue.unref(script$2), {
        mode: "basic",
        name: "demo[]",
        url: "./upload"
      }, null, _parent));
      _push(`<div x-v-if="process.browser" class="p-fluid p-grid p-formgrid" data-v-0575e15f><div class="p-field p-col-12 p-md-4" data-v-0575e15f><label for="dateformat" data-v-0575e15f>DateFormat</label> abc `);
      ...
      _push(` def </div></div><div style="${serverRenderer.ssrRenderStyle({"color": "red"})}" data-v-0575e15f> state.date: ${serverRenderer.ssrInterpolate(vue.unref(state).date)}</div>`);
      _push(serverRenderer.ssrRenderComponent(vue.unref(ImportType2), null, null, _parent));
      _push(`<!--]-->`);
    };
  }
};
_sfc_main$1.__scopeId = "data-v-0575e15f";
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("/home/forceuser/Projects/email-sender/src/pages/Home.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = new Set())).add("/home/forceuser/Projects/email-sender/src/components/ImportType.vue");
...
const __moduleId = "/home/forceuser/Projects/email-sender/src/components/Foo.jsx";
