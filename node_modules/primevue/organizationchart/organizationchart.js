...
this.primevue.organizationchart = (function (utils, vue) {
    ...
    const _hoisted_1 = { class: "p-organizationchart-table" };
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (vue.openBlock(), vue.createBlock("table", _hoisted_1, [
    ...
    var script$1 = {
        ...
        components: {
            'OrganizationChartNode': script
        }
    };

    const _hoisted_1$1 = { class: "p-organizationchart p-component" };
