...
function createRouter(options) {
  ...
  function triggerError(error) {
    markAsReady(error);
    errorHandlers.list().forEach((handler2) => handler2(error));
...
export {primebus as A, mergeProps as B, ConnectedOverlayScrollHandler as C, DomHandler as D, defineAsyncComponent as E, Fragment as F, unref as G, pushScopeId as H, popScopeId as I, defineComponent as J, PrimeVue as P, Suspense as S, Teleport as T, ZIndexUtils as Z, readonly as a, resolveComponent as b, createBlock as c, createVNode as d, createTextVNode as e, resolveDynamicComponent as f, createRouter as g, createWebHistory as h, inject as i, ref as j, onMounted as k, createSSRApp as l, withScopeId as m, resolveDirective as n, openBlock as o, withDirectives as p, renderSlot as q, reactive as r, createCommentVNode as s, toDisplayString as t, useRoute as u, vShow as v, withCtx as w, Transition as x, withKeys as y, renderList as z};
