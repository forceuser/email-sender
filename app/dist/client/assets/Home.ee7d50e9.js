import {u as usePageMeta, _ as __vitePreload} from "./index.fa316901.js";
import {D as DomHandler, n as resolveDirective, p as withDirectives, o as openBlock, c as createBlock, q as renderSlot, s as createCommentVNode, d as createVNode, t as toDisplayString, e as createTextVNode, w as withCtx, v as vShow, x as Transition, b as resolveComponent, y as withKeys, F as Fragment, z as renderList, A as primebus, Z as ZIndexUtils, C as ConnectedOverlayScrollHandler, B as mergeProps, T as Teleport, E as defineAsyncComponent, r as reactive, j as ref, G as unref, m as withScopeId, H as pushScopeId, I as popScopeId} from "./vendor.8999bd4d.js";
...
let exampleApi = registerApi("example-api", false);
let testApi = registerApi("test-api", false);
var Home_vue_vue_type_style_index_0_scoped_true_lang = "";
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "../components/ImportType.vue":
      return __vitePreload(() => import("./ImportType.12136c35.js"), true ? ["/assets/ImportType.12136c35.js","/assets/vendor.8999bd4d.js"] : void 0);
    default:
      return Promise.reject(new Error("Unknown variable dynamic import: " + path));
  }
}
const _withId = /* @__PURE__ */ withScopeId();
pushScopeId("data-v-0e819617");
...
const _hoisted_7 = /* @__PURE__ */ createTextVNode(" abc1 ");
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const Foo = defineAsyncComponent(() => __vitePreload(() => import("./Foo.98fbe89c.js"), true ? ["/assets/Foo.98fbe89c.js","/assets/Foo.a8752494.css","/assets/vendor.8999bd4d.js"] : void 0).then((mod) => mod.Foo));
    function load(file) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(Fragment, null, [
        _hoisted_1,
        _hoisted_2,
        createVNode("p", null, " ssr api call: " + toDisplayString(x.value), 1),
        createVNode("button", {
            ...
            createVNode(_component_ClientOnly, null, {
              default: _withId(() => [
                createVNode(unref(script), {
                  ...
                  "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => unref(state).date = $event),
...
_sfc_main.__scopeId = "data-v-0e819617";
